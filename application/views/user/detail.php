    ...
    <div class="row">
        ...
        <?= form_open_multipart('', ['class' => 'col-md-7 border-right'] , ['id_user' => $user['id_user']]); ?>
            ...
            <div class="p-3 py-5 ">
                ...
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Ship Name</label><input type="text" class="form-control" placeholder="password.." value="<?= set_value('namaKapal', $user['namaKapal']); ?>" name="namaKapal"></div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Jabatan</label><input type="text" class="form-control" placeholder="password.." value="<?= set_value('jabatan', $user['jabatan']); ?>" name="jabatan"></div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Shipping</label><input type="text" class="form-control" placeholder="password.." value="<?= set_value('shipping', $user['shipping']); ?>" name="shipping"></div>
                </div>
